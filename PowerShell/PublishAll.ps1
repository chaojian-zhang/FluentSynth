...
# Publish Executables
$PublishExecutables = @(
    "Music\FluentMusic\FluentMusic.csproj"
    "Music\ProceduralMusic\ProceduralMusic.csproj"
)
...
$PublishLibraries = @(
    "Core\FluentSynth\FluentSynth.csproj"
)
...
$ArchivePath = "$ArchiveFolder\FluentSynth_DistributionBuild_Windows_B$Date.zip"
...
# Validation
if (-Not (Test-Path (Join-Path $PublishFolder "FluentSynth.dll")))
{
